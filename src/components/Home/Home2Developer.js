        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <b className="purple">Azure DevOps</b>. J'aime transformer des besoins métiers en produits concrets : intégration
